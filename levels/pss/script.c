...
LOAD_MODEL_FROM_GEO(58, pss_cloudy_platform_geo),
FREE_LEVEL_POOL(),
...
OBJECT(0,8039,-3275,-5437,0,0,0,0x8000000, bhvInvFireOpensGate4),
OBJECT(MODEL_FIRE_OPEN_GATE,-4575,-2042,-7362,0,0,0,0x10000, bhvFireOpenableGate),
OBJECT(MODEL_PSS_HIDEN_GEOMETRY,6735,-3743,-3751,0,0,0,0x20000, bhvPSSHiddenGeometry),
...
OBJECT(MODEL_PSS_CLOUDY_PLATFORM,6725,-3649,-6028,0,-11,0,0x540000, bhvPSSCloudyPlatform),
OBJECT(MODEL_PSS_CLOUDY_PLATFORM,6014,-3649,-6835,0,46,0,0x470000, bhvPSSCloudyPlatform),
OBJECT(MODEL_PSS_CLOUDY_PLATFORM,7651,-3649,-5290,0,35,0,0xa0000, bhvPSSCloudyPlatform),
OBJECT(MODEL_PSS_CLOUDY_PLATFORM,7280,-3649,-5732,0,0,0,0xcf0000, bhvPSSCloudyPlatform),
OBJECT(MODEL_PSS_CLOUDY_PLATFORM,6163,-3649,-7431,0,7,0,0x640000, bhvPSSCloudyPlatform),
OBJECT(MODEL_PSS_CLOUDY_PLATFORM,5646,-3649,-7067,0,23,0,0x140000, bhvPSSCloudyPlatform),
OBJECT(MODEL_PSS_CLOUDY_PLATFORM,5615,-3649,-7554,0,-30,0,0xec0000, bhvPSSCloudyPlatform),
OBJECT(MODEL_PSS_CLOUDY_PLATFORM,5291,-3649,-6837,0,11,0,0x0, bhvPSSCloudyPlatform),
